...
# печатал ×16.1, тогда как остаток за тот же интервал сдвинулся ровно на
# единицу, то есть скорость лежала между 0 и 6 п.п./час. Хуже: если окно
# сбросилось, короткая база сравнивала числа через границу сброса.
#
